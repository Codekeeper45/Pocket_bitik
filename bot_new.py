...
TTS_VOICE_CHAR_CAP = 1200      # потолок длины озвучиваемого текста (~1 минута речи). Длиннее
...
- Коротко-средне: до ~1200 символов (голосовое примерно на минуту). Не растягивай в простыню и не перечисляй длинными списками — говори живо и по делу.
...
_HELP_SECTIONS = {
    ...
    "voice": (
        ...
        "\n"
        "ℹ️ Голосовой ответ — до ~1200 симв. (примерно минута речи) и идёт **только голосом**; если\n"
