...
_IMAGE_PROMPT_SYSTEM = (
    ...
    "точно следуй ему и усиливай ровно то, что он описал, не подменяя его замысел своим.\n"
...
_IMAGE_GEN_WITH_REFS_SYSTEM = (
    ...
    "если запрос КОНКРЕТНЫЙ — точно следуй ему и усиливай именно то, что просит пользователь.\n"
    "Референсы выбирай по номерам и в промпте явно говори, что с ними делать (взять персонажа/лицо, перенять стиль, "
    "использовать как фон, объединить). ПЕРСОНАЖИ: если в запросе люди/участники чата («нарисуй нас», «чатеры», "
