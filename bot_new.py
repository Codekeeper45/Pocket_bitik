...
_GEN_DESC_PROMPT = (  # компакт-описание кандидата каталога /gen: тип + визуальная суть (по нему текстовая модель отбирает референсы)
    ...
    "ПЕРСОНАЖИ: <кто виден — люди И любые персонажи (аниме-герой, маскот, животное, существо): кратко облик и "
    "насколько узнаваемо лицо/образ (крупно/в профиль/со спины), или «нет»>\n"
