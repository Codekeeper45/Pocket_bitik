...
def _build_tts_prompt(text: str, voice: str) -> str:
    """Короткая стилевая директива: ласковый, милый, кавайный голос.
    Намеренно минимальная — громоздкие/расплывчатые промпты у 3.1-preview чаще
    ловят ложный отказ классификатора (400). Аудио-теги [..] управляют интонацией."""
    return ("Скажи это ласково, мило и кавайно — нежным, тёплым, игривым голоском. "
            "Скобки вроде [радостно] или [шёпотом] — это интонация, не произноси их вслух:\n" + text)
